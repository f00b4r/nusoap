...
class Server extends Base {
    ...
    public function __construct($wsdl = false) {
        ...
        if ($wsdl) {
            ...
            if (is_object($wsdl) && ($wsdl instanceof \NuSOAP\Wsdl)) {
                $this->wsdl            = $wsdl;
    ...
    public function serialize_return() {
        ...
        // if fault
        if (isset($this->methodreturn) && is_object($this->methodreturn) && (($this->methodreturn instanceof \NuSOAP\Fault) || ($this->methodreturn instanceof \NuSOAP\Fault))) {
    ...
    public function register($name, $in = [], $out = [], $namespace = false, $soapaction = false, $style = false, $use = false, $documentation = '', $encodingStyle = '') {
        ...
        if (false == $soapaction) {
            if (isset($_SERVER)) {
                ...
                $this->setError('_SERVER is available');
            }
            if ($HTTPS == '1' || $HTTPS == 'on') {
                $SCHEME = 'https';
            } else {
